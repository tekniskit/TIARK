...
The driver is a modified version of an open source driver for the robot. \fxfatal{\cite{neatoGithub}} The open source driver implements an older version of the serial protocol for the Neato robot. This has been modified to implement the newer protocol which our robot uses.\\
